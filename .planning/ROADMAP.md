...
La "user story" implícita por REQ: *"como maintainer / contribuidor / reviewer,
puedo X sin fricción"*.
...
**Depends on**: Phase 3 (REL-06 documenta el release process *dentro* de `CONTRIBUTING.md`, que se creó en Phase 3 DOC-03).
...
*ROADMAP created: 2026-05-26 by `gsd-roadmapper`*
*Source: `docs/55_PRE_FASE_2_FOUNDATION.md` + `.planning/REQUIREMENTS.md`*
