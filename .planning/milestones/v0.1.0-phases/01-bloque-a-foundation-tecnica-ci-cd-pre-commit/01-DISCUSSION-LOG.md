...
| Exclude references/ y data CSVs generados | references/ + addons/\*_/data/_.csv + .planning/PROJECT.md.                     | ✓        |
| Vos decidís                               | Que researcher mire pattern OCA.                                                |          |

**User's choice:** Exclude references/ + addons/\*_/data/_.csv generados + .planning/PROJECT.md
...
| Option                                              | Description                                                                       | Selected |
| --------------------------------------------------- | --------------------------------------------------------------------------------- | -------- |
| Solo addons/l10n*py*\*                              | .coveragerc apunta a addons. Excluir tests/data/manifest. La métrica que importa. | ✓        |
...
**User's choice:** Solo addons/l10n*py*\*
